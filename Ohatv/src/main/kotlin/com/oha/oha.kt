...
class OhaTvProvider : MainAPI() {
    ...
    // غيرت الاسم قليلاً ليقوم التطبيق بتحديث الكاش إجبارياً
    ...
    // 🚩 الدالة المصلحة: تحول النص لحروف صغيرة وتزيل المسافات قبل البحث
    private fun getCountryFlag(countryName: String?): String {
        ...
        // السر هنا: trim() لإزالة المسافات، lowercase() لتوحيد الحروف
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        val homeLists = groupedChannels.map { (countryName, channelsList) ->
            ...
            val items = channelsList.mapNotNull { ch ->
                ...
                // نمرر اسم الدولة النظيف
                val displayName = "${ch.name} (${safeCountry})"

// نحول الاسم إلى Base64
...
// نحول الاسم إلى Base64
    ...
    // 🗺️ تم تحويل جميع المفاتيح إلى أحرف صغيرة (lowercase) لضمان المطابقة
