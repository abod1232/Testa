...
class AnimeiatProvider : MainAPI() {
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        // تم حذف الجزء الخاص بجلب وإضافة "أحدث الحلقات" من هنا
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        while (episodesUrl != null) {
            ...
            // تحديث الرابط للانتقال للصفحة التالية، أو سيصبح null وتتوقف الحلقة
            episodesUrl = response.links.next
        }

        // الخطوة 3: بناء وإرجاع البيانات
    ...
    override suspend fun loadLinks(
        ...
        try {
            ...
            if (playerHash.isBlank()) {
                Log.e(TAG, "Player hash not found on episode page.")
                return false
            }

            // ==================== تم التصحيح هنا ====================
            // استخدام Base64 الخاص بأندرويد ليعمل على كل الإصدارات
            ...
            if (playerID.isNullOrBlank()) {
                Log.e(TAG, "Failed to extract player ID from decoded string.")
                return false
            }
            ...
            Log.e(TAG, "An error occurred during loadLinks", e)
            return false
        }
        return true
    }
